...
/**
 * Decode a BASE64 encoded input stream to some output stream. This class implements BASE64 decoding, as specified in
 * the <a href="http://ds.internic.net/rfc/rfc1521.txt">MIME specification</a>.
 * 
...
public final class Base64Decoder {
    ...
    /**
     * Do the actual decoding. Process the input stream by decoding it and returning the resulting bytes into the output
     * stream.
     * 
     * @exception IOException If the input or output stream accesses failed.
     * @exception Base64FormatException If the input stream is not complaint with the BASE64 specification.
     */
    ...
    /**
     * Do the decoding, and return a String. This methods should be called when the decoder is used in <em>String</em>
     * mode. It decodes the input string to an output string that is returned.
     * 
     * @exception RuntimeException If the object wasn't constructed to decode a String.
     * @exception Base64FormatException If the input string is not compliant with the BASE64 specification.
     */
