...
public class HttpdConf {
	 ...
	 * returned back to the client. HINT: You may find it helpful to create a
	 * private class to store your aliases.
	 * 
	 * @param fakeName
	 *            String which contains the alias of the file or directory
	 ...
	 * 
	 * @param path
	 *            String value of path to mime.types file
	 */
	...
	/**
	 * Helper function to determine whether the name of a file or directory is
	 * an alias for another file or directory as noted in the httpd.conf file.
	 * 
	 * @param name
	 *            String value of the alias we want to check to determine
	...
	public void testPrint() {
		...
		System.out.println("ScriptAlias: " + SCRIPT_ALIAS + " "
				+ solveAlias(SCRIPT_ALIAS));
	}
}
